        ...
        Tambah Siswa </span></i> </button> </a-->
            ...
            <script type="text/javascript">
              ...
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <?php
                  include ('koneksi.php');
                  $qu=mysql_query("SELECT * FROM siswa");
                  $no=0;
                ...
                while($r_tampil=mysql_fetch_array($qu)){
                  ...
                  echo "<tr>
                    ...
                    <td>
                        ...
                        //if($r_tampil['status']=='1') {
                        if ($status == '1') $check = ' checked'; else $check = '';
                        echo '<input type="checkbox" name="check[]" class="check'.$id.'" value="'.$status.'"'.$check.' id="check'.$id.'">';
                          //}
                        //elseif($r_tampil['status']=='0') {"'.$status.'"'.$check.'
                        //echo "<input type='checkbox' class='flat-red check' id='$r_tampil[id]'>";
                          //}
                        //else {}
                    echo "</td>";
                    ...
                    <script type="text/javascript">
                        $(".check<?php echo $id; ?>").click(function() {
                          var approval_email=$('.check<?php echo $id; ?>:checked').length;
                          alert(approval_email);
                    </script>
...
<script>
  ...
  //iCheck for checkbox and radio inputs
    ...
    $(document).ready(function() {
      // var approval_email=$('.check:checked').length;
