...
<div class="wrapper">
  ...
  <aside class="main-sidebar col-md-30">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a data-toggle="modal" data-target="#validasi">
            <i class="fa fa-users"></i>
            <span>Validasi Oleh TU</span>
          </a>
        </li>
        <li class="treeview">
          <a id="data">
        ...
        <li class="treeview">
          <a id="gagal">
            <i class="fa fa-users"></i>
            <span>Siswa Tidak Diterima</span>
          </a>
        </li>
        <li class="treeview">
          <a id="user">
  ...
  <div class="content-wrapper" id="halamannya">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-history" style="margin-right:10px;"></i>Validasi Oleh TU</h4>
            </div>
